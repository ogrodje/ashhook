...
object Dependencies {
  ...
  lazy val mail: Modules = Seq(
    "org.eclipse.angus" % "angus-activation" % "2.0.2" % "runtime",
    "org.eclipse.angus" % "angus-mail"       % "2.0.3",
    "org.eclipse.angus" % "jakarta.mail"     % "2.0.3",
    "org.eclipse.angus" % "imap"             % "2.0.3" % "provided",
  ...
  lazy val projectResolvers: Seq[MavenRepository] = Seq(
    ...
    "Jakarta Snapshots" at "https://jakarta.oss.sonatype.org/content/repositories/snapshots/"
  )
}
